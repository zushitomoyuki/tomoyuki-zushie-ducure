...
public class EnglishWordQuizAppTested {
        ...
        while (choice != 3) {
            ...
            if (scanner.hasNextInt()) {
                ...
                switch (choice) {
                    ...
                    case 3: 
                        System.out.println("プログラムを終了します。"); break; 
                    default:
                        System.out.println("⚠️ 無効な選択です。1から3の数字を入力してください。");
                }
            } else { 
    ...
    private static void registerWord() {
        ...
        System.out.println("✅ 単語: '" + english + "' (日本語訳: '" + japanese + "') を登録しました。");
    }
    ...
    private static void startQuiz() {
        ...
        for (int i = 0; i < totalQuestions; i++) {
            ...
            String currentEnglish = englishWords.get(index);
            String correctAnswer = japaneseWords.get(index);
            
            System.out.println("--- 第" + (i + 1) + "問 ---");
            System.out.println(currentEnglish + "の意味は？");
            System.out.print("あなたの解答: ");
            
            String userAnswer = scanner.nextLine().trim();
            
            if (userAnswer.equals(correctAnswer)) { // 厳密な判定 (全角/半角、ひらがな/カタカナ等も区別)
